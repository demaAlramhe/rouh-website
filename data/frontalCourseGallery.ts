...
export const frontalCourseGallery = {
  ...
  images: [
    ...
    },
    {
      ...
      alt: "أربع مشاركات يحملن الشهادات وأدوات صوتية في قاعة تدريب مضيئة",
    },
    {
      src: "/images/frontal-course-gallery/04-graduation-floor-bowls-circle.png",
    ...
    },
    {
      ...
      alt: "خمس مشاركات يبتسمن مع شهادات في فضاء تدريبي بجدران خشبية",
    },
    {
      src: "/images/frontal-course-gallery/09-cohort-diplomas-bowls-line.png",
      alt: "صف من المشاركات يحملن الدبلومات مع طاسات تبتية في المقدمة",
    },
  ],
} as const;
