      ...
      <div>
        <div className="grid gap-4 md:grid-cols-2">
          {journeyItems.map((item, index) => (
            ...
            >
              <span className="mb-5 grid size-12 place-items-center rounded-full bg-rouh-blue/11 text-sm font-black text-rouh-blue shadow-[inset_0_1px_0_rgba(255,255,255,0.6)] ring-1 ring-rouh-blue/16">
